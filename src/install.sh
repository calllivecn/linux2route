...
cp -v linux2route.conf $HOSTAPD_DIR
cp -v mkbridge.sh $HOSTAPD_DIR
cp -v route-dnsmasq.conf $HOSTAPD_DIR
cp -v hostapd.conf $HOSTAPD_DIR
cp -v route-nftables.sh $HOSTAPD_DIR
